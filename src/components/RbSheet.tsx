import { windowHeight } from '@/utils/theme/globalStyles';
import React, {
    forwardRef,
    memo,
    useImperativeHandle,
...
import { useSafeAreaInsets } from 'react-native-safe-area-context';
  ...
  const RbSheet = forwardRef((props: iProps, ref) => {
    const {height = 'auto', children = <View />, containerStyle, onClose} = props;
  ...
  const styles = StyleSheet.create({
    ...
    container: {
      ...
      width: '100%',
      overflow: 'hidden',
      borderTopLeftRadius: 4 * styleGlobalDefinitions.borderRadius.borderRadius,
      borderTopRightRadius: 4 * styleGlobalDefinitions.borderRadius.borderRadius,
    },
    innerContainer: {
      flex: 1,
